          ...
          <FilterContainer className="search-filter d-flex flex-column gap-3">
            ...
            <div className="d-flex flex-column flex-md-row gap-3">
                <FilterItem>
                    ...
                    <FilterData><p>{car.name}</p></FilterData> 
                </FilterItem>
                <FilterItem>
                    <label>Kategori</label>
                    <FilterData><p>{car.category}</p></FilterData>  
                </FilterItem>
                <FilterItem>
                    <label>Harga</label>
                    <FilterData><p>Rp {Intl.NumberFormat('ID').format(car.price)} / hari</p></FilterData>    
                </FilterItem>
                <FilterItem>
                    <label>Status</label>
                    <FilterData>{car.status === false ? <p>Disewakan</p> : <p>Tidak Disewakan</p> }</FilterData>
                </FilterItem> 
                <Link to='/car-list' style={{ textDecoration: 'none', }} ><Button variant='outlined' className='text-capitalize' style={{width:"100%", height:"100%"}} >Ubah</Button></Link>
            </div>
          </FilterContainer>
          <DetailInfo>
            <DetailDesc>
